...
#ifndef MINS_UPDATERWHEELR_H
#define MINS_UPDATERWHEELR_H
...
private:
  ...
  bool get_bounding_data(double t_given, std::vector<RoverWheelData> &data_stack, RoverWheelData &data1, RoverWheelData &data2);
   ...
   */
  static RoverWheelData interpolate_data(const RoverWheelData data1, const RoverWheelData data2, double timestamp);
   ...
   */
  void preintegration_intrinsics_3D(double dt, RoverWheelData data);
